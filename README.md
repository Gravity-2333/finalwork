...
- 可切换 AI Provider：本地 Ollama、云端 Ollama、OpenAI-compatible、Mock
- 学习进度记录、在线测验、错题复盘
- 人脸识别核验登录页与语音交互入口
- 云端 Ollama 可获取并测试可用模型列表
- API Key 支持手动填写或按系统环境变量名读取
- 自动截图与 Word 报告生成
...
- `DEEPSEEK_API_KEY`：DeepSeek API 密钥，可在 OpenAI-compatible 模式中填写该变量名读取。
